          ...
          <tbody>
            {ledger.map((row) => (
              <tr key={row.id}>
                ...
                <td>
                  {row.bill_uploaded ? (
                    <button className="view-bill-btn" title="View bill" onClick={() => setViewImageUrl(getBillImageUrl(row.bill_url))}>
                ...
                <td>
                  <button className="edit-btn" title="View" onClick={() => setSelectedRow(row)}>
