                    ...
                    <tr key={row.id}>
                      ...
                      <td>
                        {(() => {
                          ...
                          return billPath ? (
                            <button className="view-bill-btn" title="View bill" onClick={() => openImage(billPath)}>
                      ...
                      <td>
                        <div style={{ display: 'flex', gap: 6 }}>
                          <button className="edit-btn" title="Edit" onClick={() => openEdit(row)}>
                            <i className="ti ti-edit" />
                          </button>
                          <button className="delete-btn" title="Delete" onClick={() => handleDelete(row.id)}>
